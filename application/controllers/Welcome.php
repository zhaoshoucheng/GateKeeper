...
//        print_r("loop_over");
    ...
    public function testSign(){
        $url = "https://sts.didichuxing.com/sg1/api/signalpro/api/Overview/getNowDate";
        $queryMap = [
            "app_id"=>"test",
            "city_id"=>"12",
            "nonce"=>"111111",
        ...
        $sign = getOpenSign($queryMap,"4b02e6c56bcce94ee5de073df3d512d5");
        $queryStr = http_build_query($queryMap)."&sign=".$sign;
        $res=$this->request_post($url, $queryStr);
        print_r($res);exit;
    }
