...
class Demo extends MY_Controller
{
    ...
    {
        $sql = 'SELECT count(*) as cnt,avg(delay) as avg_delay,downstream_ramp from cn_signal_pro_freeway_segment_index_online_* where city_id=23 and day_time_hms>="2020-05-06 07:00:00" and day_time_hms<="2020-05-06 10:00:00" group by downstream_ramp order by cnt desc limit 10000';
