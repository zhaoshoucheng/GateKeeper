<?php
namespace Optimize\Spacetimedragam;
...
class JunctionResponse {
  ...
  /**
   * @var (\Optimize\Spacetimedragam\MatchPoint[])[]
   */
      ...
      self::$_TSPEC = array(
        ...
        2 => array(
          ...
          'elem' => array(
            ...
            'elem' => array(
              'type' => TType::STRUCT,
              'class' => '\Optimize\Spacetimedragam\MatchPoint',
              ),
            ),
          ),
        3 => array(
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            for ($_i4 = 0; $_i4 < $_size0; ++$_i4)
            {
              ...
              {
                $elem11 = null;
                $elem11 = new \Optimize\Spacetimedragam\MatchPoint();
        ...
        case 4:
          if ($ftype == TType::LST) {
            ...
            for ($_i16 = 0; $_i16 < $_size12; ++$_i16)
            {
              ...
              {
                $elem23 = null;
                $elem23 = new \Optimize\Spacetimedragam\MatchPoint();
...
class ContinueTSGraphResponse {
  ...
  public $errmsg = null;
  /**
   * @var \Optimize\Spacetimedragam\JunctionResponse[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Optimize\Spacetimedragam\JunctionResponse',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem33 = null;
              $elem33 = new \Optimize\Spacetimedragam\JunctionResponse();
