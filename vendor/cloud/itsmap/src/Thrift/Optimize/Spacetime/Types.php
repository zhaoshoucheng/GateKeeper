...
class JunctionResponse {
  ...
  /**
   * @var (\Optimize\Spacetime\MatchPoint[])[]
   */
      ...
      self::$_TSPEC = array(
        ...
        2 => array(
          ...
          'elem' => array(
            ...
            'elem' => array(
              'type' => TType::STRUCT,
              'class' => '\Optimize\Spacetime\MatchPoint',
              ),
            ),
          ),
        3 => array(
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            for ($_i4 = 0; $_i4 < $_size0; ++$_i4)
            {
              ...
              {
                $elem11 = null;
                $elem11 = new \Optimize\Spacetime\MatchPoint();
        ...
        case 4:
          if ($ftype == TType::LST) {
            ...
            for ($_i16 = 0; $_i16 < $_size12; ++$_i16)
            {
              ...
              {
                $elem23 = null;
                $elem23 = new \Optimize\Spacetime\MatchPoint();
...
class ContinueTSGraphResponse {
  ...
  public $errmsg = null;
  /**
   * @var \Optimize\Spacetime\JunctionResponse[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Optimize\Spacetime\JunctionResponse',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem33 = null;
              $elem33 = new \Optimize\Spacetime\JunctionResponse();
...
class TodSlice {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TodSlice');
