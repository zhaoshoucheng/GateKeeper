...
class Request {
  ...
  public function write($output) {
    ...
    if ($this->x !== null) {
      $xfer += $output->writeFieldBegin('x', TType::DOUBLE, 4);
      $xfer += $output->writeDouble($this->x);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->y !== null) {
      $xfer += $output->writeFieldBegin('y', TType::DOUBLE, 5);
...
class ScatterPoint {
  ...
  public function write($output) {
    ...
    if ($this->stopLineTimestamp !== null) {
      $xfer += $output->writeFieldBegin('stopLineTimestamp', TType::I64, 1);
      $xfer += $output->writeI64($this->stopLineTimestamp);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->stopDelayBefore !== null) {
      $xfer += $output->writeFieldBegin('stopDelayBefore', TType::I32, 2);
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->scatterPoint = new \ScatterPoint();
